      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className="text-gray-200 hidden md:block">
            My name is Nick and I&apos;m a technology enthusiast with a passion
            for building computers, developing software, gaming, and staying
            active through regular gym visits. My interest in technology extends
            from hands-on hardware assembly to the intricate process of software
